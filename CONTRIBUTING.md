...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/trantoan960/nodejs-api-boilerplate#-getting-started) section in README.md)
